from pyvcell_fvsolver import __version__, version, solve  # type: ignore
...
def test_solve() -> None:
    ...
    retcode_1: int = solve(fvInputFilename=str(fv_input_file), vcgInputFilename=str(vcg_input_file),
                           outputDir=str(test_output_dir_1))
