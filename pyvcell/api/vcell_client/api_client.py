...
from pyvcell.api.vcell_client.api_response import ApiResponse, T as ApiResponseT
import pyvcell.api.vcell_client.models
from pyvcell.api.vcell_client import rest
from pyvcell.api.vcell_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pyvcell.api.vcell_client.models, klass)
