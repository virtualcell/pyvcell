    ...
    def make_instance(self, include_optional) -> FieldDataShape:
        ...
        if include_optional:
            return FieldDataShape(
                extent = pyvcell.api.vcell_client.models.extent.Extent(
                    x = 1.337,
                    y = 1.337,
                    z = 1.337, ),
                origin = pyvcell.api.vcell_client.models.origin.Origin(
                    x = 1.337,
                    y = 1.337,
                    z = 1.337, ),
                isize = pyvcell.api.vcell_client.models.i_size.ISize(
                    x = 56,
                    y = 56,
                    z = 56, ),
                data_identifier = [
                    pyvcell.api.vcell_client.models.data_identifier.DataIdentifier(
                        name = '',
                        display_name = '',
                        variable_type = pyvcell.api.vcell_client.models.variable_type.VariableType(
                            type = 56,
                            ...
                            default_units = '',
                            type_name = '', ),
                        domain = pyvcell.api.vcell_client.models.domain.Domain(
                            name = '', ),
                        b_function = True,
                        function = True,
                        visible = True, )
