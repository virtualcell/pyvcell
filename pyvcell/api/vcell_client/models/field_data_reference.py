...
class FieldDataReference(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "externalDataIdentifier": ExternalDataIdentifier.from_dict(obj["externalDataIdentifier"]) if obj.get("externalDataIdentifier") is not None else None,
            "externalDataAnnotation": obj.get("externalDataAnnotation"),
            "externalDataIDSimRefs": [KeyValue.from_dict(_item) for _item in obj["externalDataIDSimRefs"]] if obj.get("externalDataIDSimRefs") is not None else None
        })
        return _obj
