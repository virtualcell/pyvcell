...
from pyvcell._internal.api.vcell_client.api_response import ApiResponse, T as ApiResponseT
import pyvcell._internal.api.vcell_client.models
from pyvcell._internal.api.vcell_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pyvcell._internal.api.vcell_client.models, klass)
