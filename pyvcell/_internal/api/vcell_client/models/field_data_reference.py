...
class FieldDataReference(BaseModel):
    ...
    simulations_referencing_this_id: Optional[List[StrictStr]] = Field(
        default=None, alias="simulationsReferencingThisID"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fieldDataID": ExternalDataIdentifier.from_dict(obj["fieldDataID"])
            if obj.get("fieldDataID") is not None
            else None,
