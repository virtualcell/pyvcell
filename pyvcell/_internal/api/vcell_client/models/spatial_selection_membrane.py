    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in SpatialSelectionMembrane) in the input: " + _key
                )

        _obj = cls.model_validate({
            "curveSelectionInfo": CurveSelectionInfo.from_dict(obj["curveSelectionInfo"])
            if obj.get("curveSelectionInfo") is not None
            else None,
            ...
            "selectionSource": SampledCurve.from_dict(obj["selectionSource"])
            if obj.get("selectionSource") is not None
            else None,
        })
        return _obj
