...
class SampledCurve(ControlPointCurve):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "beginningCoordinate": Coordinate.from_dict(obj["beginningCoordinate"])
            if obj.get("beginningCoordinate") is not None
            else None,
            "defaultNumSamples": obj.get("defaultNumSamples"),
            "endingCoordinate": Coordinate.from_dict(obj["endingCoordinate"])
            if obj.get("endingCoordinate") is not None
            else None,
            ...
            "valid": obj.get("valid"),
            "controlPoints": [Coordinate.from_dict(_item) for _item in obj["controlPoints"]]
            if obj.get("controlPoints") is not None
            else None,
            "controlPointCount": obj.get("controlPointCount"),
            "controlPointsVector": [Coordinate.from_dict(_item) for _item in obj["controlPointsVector"]]
            if obj.get("controlPointsVector") is not None
            else None,
