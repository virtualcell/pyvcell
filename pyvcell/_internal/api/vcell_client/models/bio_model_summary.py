    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in BioModelSummary) in the input: " + _key
                )
        ...
        _obj = cls.model_validate({
            ...
            "publicationInformation": [PublicationInfo.from_dict(_item) for _item in obj["publicationInformation"]]
            if obj.get("publicationInformation") is not None
            else None,
            "vCellSoftwareVersion": VCellSoftwareVersion.from_dict(obj["vCellSoftwareVersion"])
            if obj.get("vCellSoftwareVersion") is not None
            else None,
        })
        return _obj
