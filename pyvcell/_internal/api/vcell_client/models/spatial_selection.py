...
class SpatialSelection(BaseModel):
    ...
    type: StrictStr
    smallest_mesh_cell_dimension_length: Optional[Union[StrictFloat, StrictInt]] = Field(
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        "Contour": "SpatialSelectionContour",
        "Membrane": "SpatialSelectionMembrane",
        "Volume": "SpatialSelectionVolume",
    }
    ...
    def from_json(
        cls, json_str: str
    ) -> Optional[Union[SpatialSelectionContour, SpatialSelectionMembrane, SpatialSelectionVolume]]:
    ...
    def from_dict(
        ...
        if object_type == "SpatialSelectionContour":
            return import_module(
                "pyvcell._internal.api.vcell_client.models.spatial_selection_contour"
            ).SpatialSelectionContour.from_dict(obj)
        if object_type == "SpatialSelectionMembrane":
            return import_module(
                "pyvcell._internal.api.vcell_client.models.spatial_selection_membrane"
            ).SpatialSelectionMembrane.from_dict(obj)
        if object_type == "SpatialSelectionVolume":
            return import_module(
                "pyvcell._internal.api.vcell_client.models.spatial_selection_volume"
            ).SpatialSelectionVolume.from_dict(obj)

        raise ValueError(
            "SpatialSelection failed to lookup discriminator value from "
            + json.dumps(obj)
