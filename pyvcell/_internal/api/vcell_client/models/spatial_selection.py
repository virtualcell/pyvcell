...
class SpatialSelection(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[SpatialSelectionContour, SpatialSelectionMembrane, SpatialSelectionVolume]]:
        ...
        if object_type ==  'SpatialSelectionContour':
            return import_module("pyvcell._internal.api.vcell_client.models.spatial_selection_contour").SpatialSelectionContour.from_dict(obj)
        if object_type ==  'SpatialSelectionMembrane':
            return import_module("pyvcell._internal.api.vcell_client.models.spatial_selection_membrane").SpatialSelectionMembrane.from_dict(obj)
        if object_type ==  'SpatialSelectionVolume':
            return import_module("pyvcell._internal.api.vcell_client.models.spatial_selection_volume").SpatialSelectionVolume.from_dict(obj)
