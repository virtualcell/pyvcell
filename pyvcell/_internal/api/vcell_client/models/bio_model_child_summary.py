...
class BioModelChildSummary(BaseModel):
    ...
    simulation_context_annotations: Optional[List[StrictStr]] = Field(
        default=None, alias="simulationContextAnnotations"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in BioModelChildSummary) in the input: " + _key
                )
        ...
        _obj = cls.model_validate({
            ...
            "applicationInfo": [ApplicationInfo.from_dict(_item) for _item in obj["applicationInfo"]]
            if obj.get("applicationInfo") is not None
            else None,
        })
        return _obj
