...
class Curve(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AnalyticCurve, CompositeCurve, ControlPointCurve, SampledCurve, Spline]]:
        ...
        if object_type ==  'AnalyticCurve':
            return import_module("pyvcell._internal.api.vcell_client.models.analytic_curve").AnalyticCurve.from_dict(obj)
        if object_type ==  'CompositeCurve':
            return import_module("pyvcell._internal.api.vcell_client.models.composite_curve").CompositeCurve.from_dict(obj)
        if object_type ==  'ControlPointCurve':
            return import_module("pyvcell._internal.api.vcell_client.models.control_point_curve").ControlPointCurve.from_dict(obj)
