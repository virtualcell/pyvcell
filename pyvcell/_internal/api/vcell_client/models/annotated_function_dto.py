    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in AnnotatedFunctionDTO) in the input: " + _key
                )
        ...
        _obj = cls.model_validate({
            ...
            "functionType": VariableType.from_dict(obj["functionType"])
            if obj.get("functionType") is not None
            else None,
