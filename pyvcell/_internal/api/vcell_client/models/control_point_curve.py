...
class ControlPointCurve(Curve):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {"SampledCurve": "SampledCurve", "Spline": "Spline"}
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[SampledCurve, Spline]]:
        ...
        raise ValueError(
            "ControlPointCurve failed to lookup discriminator value from "
            + json.dumps(obj)
