...
from pyvcell._internal.api.vcell_client.api_client import ApiClient, RequestSerialized
from pyvcell._internal.api.vcell_client.api_response import ApiResponse
from pyvcell._internal.api.vcell_client.rest import RESTResponseType
...
class BioModelResourceApi:
    ...
    def get_bio_model_summaries(
        self,
        include_public_and_shared: Annotated[
            Optional[StrictBool],
            Field(description="Includes BioModel summaries that are public or shared with requester. Default is true."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_bio_model_vcml_serialize(
        ...
        # set the HTTP header `Accept`
        if "Accept" not in _header_params:
            _header_params["Accept"] = self.api_client.select_header_accept(["text/xml", "application/json"])
    ...
    def save_bio_model(
        ...
        new_name: Annotated[
            Optional[StrictStr],
            Field(description="Name to save new BioModel under. Leave blank if re-saving existing BioModel."),
        ] = None,
        sims_requiring_updates: Annotated[
            Optional[List[StrictStr]],
            Field(description="The name of simulations that will be prepared for future execution."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _save_bio_model_serialize(
        ...
        if _content_type:
            ...
            _default_content_type = self.api_client.select_header_content_type(["application/xml"])
