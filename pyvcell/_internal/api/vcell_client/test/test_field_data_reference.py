    ...
    def make_instance(self, include_optional) -> FieldDataReference:
        ...
        if include_optional:
            return FieldDataReference(
                external_data_identifier = pyvcell._internal.api.vcell_client.models.external_data_identifier.ExternalDataIdentifier(
                ...
                external_data_id_sim_refs = [
                    pyvcell._internal.api.vcell_client.models.key_value.KeyValue(
                        value = 1.337, )
                    ]
            )
        else:
