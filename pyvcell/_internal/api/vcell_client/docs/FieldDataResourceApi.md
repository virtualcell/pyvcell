# pyvcell.\_internal.api.vcell_client.FieldDataResourceApi
...
with pyvcell._internal.api.vcell_client.ApiClient(configuration) as api_client:
    ...
    api_instance = pyvcell._internal.api.vcell_client.FieldDataResourceApi(api_client)
    file = None # bytearray |  (optional)
    file_name = 'file_name_example' # str |  (optional)
    extent = pyvcell._internal.api.vcell_client.Extent() # Extent |  (optional)
    i_size = pyvcell._internal.api.vcell_client.ISize() # ISize |  (optional)
    ...
    origin = pyvcell._internal.api.vcell_client.Origin() # Origin |  (optional)
...
with pyvcell._internal.api.vcell_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pyvcell._internal.api.vcell_client.FieldDataResourceApi(api_client)
    source_model = pyvcell._internal.api.vcell_client.SourceModel() # SourceModel |  (optional)
...
with pyvcell._internal.api.vcell_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pyvcell._internal.api.vcell_client.FieldDataResourceApi(api_client)
    field_data = pyvcell._internal.api.vcell_client.FieldData() # FieldData |  (optional)
