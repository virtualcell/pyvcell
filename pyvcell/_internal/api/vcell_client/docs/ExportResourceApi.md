...
with pyvcell._internal.api.vcell_client.ApiClient(configuration) as api_client:
    ...
    api_instance = pyvcell._internal.api.vcell_client.ExportResourceApi(api_client)
    n5_export_request = pyvcell._internal.api.vcell_client.N5ExportRequest() # N5ExportRequest |  (optional)
