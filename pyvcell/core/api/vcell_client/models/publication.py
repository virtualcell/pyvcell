...
class Publication(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "biomodelRefs": [BiomodelRef.from_dict(_item) for _item in obj["biomodelRefs"]]
            if obj.get("biomodelRefs") is not None
            else None,
            "mathmodelRefs": [MathmodelRef.from_dict(_item) for _item in obj["mathmodelRefs"]]
            if obj.get("mathmodelRefs") is not None
            else None,
            "date": obj.get("date"),
        })
        return _obj
