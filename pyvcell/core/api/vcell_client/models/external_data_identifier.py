    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError(
                    "Error due to additional fields (not defined in ExternalDataIdentifier) in the input: " + _key
                )

        _obj = cls.model_validate({
            "key": KeyValue.from_dict(obj["key"]) if obj.get("key") is not None else None,
            ...
            "dataKey": KeyValue.from_dict(obj["dataKey"]) if obj.get("dataKey") is not None else None,
        })
        return _obj
